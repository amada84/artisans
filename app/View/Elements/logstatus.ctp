<?php if (isset($logged_user) && !empty($logged_user)): ?>
	<li class="dropdown">
		<a href="#" id="drop2" role="button" class="dropdown-toggle" data-toggle="dropdown">Bonjour <?php echo $logged_user['username']; ?> <b class="caret"></b></a>
        ...
        <?php if(!$this->Session->read('Auth.User.is_admin')) : ?>
            ...
            <?php endif; ?>
            <li role="presentation"><?php echo $this->Html->link(__d('articles', 'Gerer mes annonces'), array('controller' => 'ads', 'action' => 'viewUserAd')); ?></li>
