	...
	<div class="col-md-4">
		<?php
			...
			echo $this->Form->input('username', array(
			    ...
			    'label' => false,
				'PlaceHolder' => __d('users', 'Votre pseudo'),
				'class' => 'form-control',
			...
			if (!empty($packs)) {
				echo $this->Form->input('pack_id', array(
					'type' => 'select',
					'class' => 'form-control',
					'div' => array(
				        'class' => 'form-group',
					...
					'label' => array(
						'text' => __d('users', 'Votre pack')
					),
					'values' => $packs,
					'before' => '<div class="col-sm-10 UserPackId">',
			    	'after' => '</div>',
			    	'error' => array(
			    		'attributes' => array('class' => 'error-message pack-id-error')
			    	),
				));
			}
